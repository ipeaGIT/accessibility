...
Now let's create a very simple custom decay function that uses a parameter `k` to convert the travel cost `travel_cost` between origin `i` and destination `j` into an impedance factor.
