...
The `gravity_access()` and `floating_catchment_area()` functions can use any custom decay function that converts travel cost `travel_cost` to and impedance factor. For convenience, the package currently includes the following decay functions:
