...
The BFCA metric calculates accessibility accounting for competition effects while simultaneously correcting for issues of inflation of demand and service levels that are present in previous floating  catchment area measures. It is the most recent FCA metric and it was originally proposed by Paez et al. [@paez2019fca] and named in Pereira et al. [@pereira2020geographic].
